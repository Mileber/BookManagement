...
<body>
	...
	<div class="container">
	  	 <form class="form-horizontal" action="addServlet" method="post" enctype="multipart/form-data">
	  	 	<div class="page-header">
				<h1>新增图书信息<small>所有栏目都为必填项</small></h1>
			</div>
			<div class="col-sm-7">
				<div class="form-group">
					<label class="col-sm-2 control-label">书名</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="bookname" placeholder="请填写书籍名称"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">作者</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="author" placeholder="请填写作者姓名"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">出版社</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="press" placeholder="请填写出版社姓名"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">出版时间</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="pubdate" placeholder="请填写图书出版时间"/>
					</div>
				</div>
				<div class="form-group">
